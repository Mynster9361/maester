---
title: "CIS.M365.2.1.11 - (L2) Ensure comprehensive attachment filtering is applied"
description: "2.1.11 (L2) Ensure comprehensive attachment filtering is applied The Common Attachment Types Filter lets a user block known and custom malicious file types from being attached to emails. The policy provided by Microsoft covers 53 extensions, and an additional custom list of extensions can be define…"
slug: /tests/CIS.M365.2.1.11
