---
title: "CIS.M365.8.2.3 - Ensure external Teams users cannot initiate conversations"
description: "8.2.3 (L1) Ensure external Teams users cannot initiate conversations This setting prevents external users who are not managed by an organization from initiating contact with users in the protected organization. The recommended state is to uncheck **External users with Teams accounts not managed by…"
slug: /tests/CIS.M365.8.2.3
